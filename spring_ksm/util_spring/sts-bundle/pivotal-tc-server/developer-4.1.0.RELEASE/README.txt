VMware tc Server Developer Edition
Version: 4.1.0.RELEASE
Build Date: 20200403001706
...
setup a basic instance that is capable of handling both HTTP and HTTPS:
        ...
        * tcserver create --template nio --template nio-ssl example-instance
...
To start this instance, use tcserver start
        ...
        * tcserver start start example-instance
...
Edition:
	...
	* Product Information: https://tanzu.vmware.com/spring-runtime

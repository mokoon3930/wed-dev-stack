...
//		casting.autoCasting();
	...
	/*
	 * 자동 형변환(묵시적 형변환)
	 * - 자동으로 형변환이 이루어 지기 때문에 따로 형 변환 하지 않아도 된다.
	 * */
	public void autoCasting() {
		...
		int result = b + s; // byte, short 타입이 데이터는 연산식 무조건 int 타입
	 ...
	 * (자로형)값;
	 * 
	 * - 범위가 큰 크기의 자료형의 데이터를 작은 크기의 자료형으로 변환 하려고 할때
